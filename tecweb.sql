...
(1, '{en|Funko Pop} 1', 'Funko1.jpg', 'Action figure di personaggio seduto', 'Descrizione test', 'Giappone', 1, 'FP001', '10_cm|centimetri_ x 10_cm|centimetri_ x 10_cm|centimetri_', '20[gr|grammi]' , 1, 10.00),
(2, '{en|Funko Pop} 2', 'Funko1.jpg', 'Action figure di personaggio seduto', 'Descrizione test', 'Giappone', 1, 'FP001', '10_cm|centimetri_ x 10_cm|centimetri_ x 10_cm|centimetri_', '20[gr|grammi]' , 1, 15.00),

(3, '{en|Far Cry} 6 per {en|XBox one}', 'farcry6.jpg', 'Custodia del gioco per XBOX One', 'Descrizione test', 'Francia', 2, 'UB001', '10_cm|centimetri_ x 10_cm|centimetri_ x 10_cm|centimetri_', '20[gr|grammi]', 2, 60.00),
(4, '{en|Prince of Persia: The Sands of Time} per {en|XBox one}', 'prince.jpg', 'Custodia del gioco per XBOX One', 'Descrizione test', 'Francia', 2, 'UB002', '10_cm|centimetri_ x 10_cm|centimetri_ x 10_cm|centimetri_', '20[gr|grammi]' , 2, 60.00),

(5, '{ja|Goku} {en|T-shirt} XL', 'goku.jpg', 'T-shirt Rossa con logo in giapponese in alto a destra', 'Descrizione test', 'Cina', 3, 'APP001', '[XL|{en|Extra Large}]', NULL , 2, 30.00);
