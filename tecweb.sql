...
(29, '[en]Scott Pilgrim[/en]. Una vita niente male (Vol. 1)', 'uploads/scott-pilgrim-vol-1.jpg', NULL, 'Primo volume della graphic novel [en]Scott pilgrim[/en]". \r\nLa vita di [en]Scott Pilgrim[/en] è davvero niente male. \r\nHa ventitré anni, suona in una [en]band[/en], si sveglia all\'ora che gli pare e ultimamente esce anche con una tipa carina che praticamente gli muoia dietro.', 'Canada', 11, '8817040843', '12 x 1 x 18 _cm|centimetri_', '259_g|grammi_', 2, '9.40'),
...
(96, '[ja]Muten Roshi[/ja] [en]Trucker cap Dragon Ball[/en] Z', 'uploads/dragon-ball-berretto-11672694709.jpg', '', 'Cappello da [en]baseball[\en] con licenza ufficiale [en]Dragon Ball[/en] Z\nToppa Super [ja]Saiyan Goku[/ja] sul davanti, motivo: personaggio sul lato ', 'USA', 18, 'CL-DBZ-1-GO3', 'Taglia Unica', '100_g|grammi_', 5, '19.99'),
(97, '[ja]Saiyan Goku[/ja] [en]Trucker cap Dragon Ball[/en] Z', 'uploads/dragon-ball-berretto-21672694827.jpg', '', 'Cappello da [en]baseball[\en] con licenza ufficiale [en]Dragon Ball[/en] Z\nToppa [ja]Muten Roshi[/ja] sul davanti, motivo: personaggio sul lato ', 'USA', 18, 'CL-DBZ-2-GO3', 'Taglia unica', '100_g|grammi_', 5, '19.99');
